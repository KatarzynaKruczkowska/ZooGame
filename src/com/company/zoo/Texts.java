...
public class Texts {
    public final static String WELCOME = "Witam w grze ZOO.\n " +
            "Jesteś właścicielem mini Zoo. Dbaj o zwierzęta, które hodujesz.\n " +
    ...
    public static final String ELEPHANT_EATING_SOUND = "mniaaaammm";
